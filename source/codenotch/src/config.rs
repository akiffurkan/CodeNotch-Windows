...
pub struct Config {
    ...
    pub notch_y: f64,
    /// Screen edge where the notch docks: "right", "left", "top", "bottom"
    #[serde(default = "default_notch_edge")]
    pub notch_edge: String,
    /// Ratio along the chosen edge (0.0 = start/top/left, 0.5 = middle, 1.0 = end/bottom/right)
    #[serde(default = "default_notch_offset")]
    ...
    #[serde(default = "default_gemini_budget")]
    pub gemini_api_budget: u64,
    #[serde(default)]
    pub claude_api_key: String,
    #[serde(default = "default_claude_budget")]
    pub claude_api_budget: f64,
    #[serde(default)]
    pub copilot_token: String,
    #[serde(default)]
    pub nvidia_api_key: String,
    /// Quota display mode: "remaining" (kalan, default/left) vs "used" (kullanılan/right)
...
fn default_gemini_budget() -> u64 {
    1_000_000
}
fn default_claude_budget() -> f64 {
    20.0
}
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            notch_offset: default_notch_offset(),
            scale: default_scale(),
            ...
            gemini_api_budget: default_gemini_budget(),
            claude_api_key: String::new(),
            claude_api_budget: default_claude_budget(),
...
pub fn load() -> Config {
    ...
    if cfg.notch_edge.is_empty() {
        cfg.notch_edge = "right".into();
    }
    if cfg.notch_offset <= 0.0 && cfg.notch_y > 0.0 {
        cfg.notch_offset = cfg.notch_y;
    }
    cfg.notch_offset = cfg.notch_offset.clamp(0.0, 1.0);
